...
import { Loader2, BookOpen, UserCircle } from "lucide-react";
...
export default function FacultyDashboard() {
  ...
  const [facultyData, setFacultyData] = useState<{name: string, subject: string, gender?: string} | null>(null);
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 sm:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            {!facultyData?.name || facultyData.name === "Faculty" ? (
              <div className="bg-orange-50 text-orange-800 p-4 rounded-xl inline-block mb-6 border border-orange-100">
